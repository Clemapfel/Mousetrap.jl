...
:STYLE_TARGET_BUTTON_PRESSED => "`Button` while depressed",
    ...
    :STYLE_TARGET_VIEWPORT_HORIZONTAL_SCROLLBAR_SLIDER => "Moving element of the horizontal `ScrollBar` of a `Viewport`",
    ...
    :STYLE_TARGET_VIEWPORT_VERTICAL_SCROLLBAR_SLIDER => "Moving element of the vertical `ScrollBar` of a `Viewport`",
