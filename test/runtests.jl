...
function test_stye_class(widget::Container)
    @testset "CSS" begin
        add_css!("""
        .test_class {
            border-radius: 10%;
        ...
        @test serialize(RGBA(1, 0, 0.5, 1)) == "rgba(255, 0, 0.5, 255)"
    end
    ...
    @testset "StyleClass" begin
        ...
        targets = [
            ...
            STYLE_TARGET_ACTION_BAR_BOX_START
            STYLE_TARGET_ACTION_BAR_BOX_END
            ...
            STYLE_TARGET_IMAGE_DISPLAY
            STYLE_TARGET_LABEL
            STYLE_TARGET_LEVEL_BAR
            STYLE_TARGET_LEVEL_BAR_TROUGH
            ...
            STYLE_TARGET_POPOVER_ARROW
            STYLE_TARGET_POPOVER_BUTTON
            STYLE_TARGET_POPOVER_BUTTON_INDICATOR
            STYLE_TARGET_POPOVER_MENU
            STYLE_TARGET_POPOVER_MENU_ARROW
            STYLE_TARGET_POPUP_MESSAGE_OVERLAY
            STYLE_TARGET_POPUP_MESSAGE_OVERLAY_POPUP_MESSAGE
            STYLE_TARGET_POPUP_MESSAGE_OVERLAY_POPUP_MESSAGE_CONTENT
            STYLE_TARGET_POPUP_MESSAGE_OVERLAY_POPUP_MESSAGE_ACTION_BUTTON
            STYLE_TARGET_POPUP_MESSAGE_OVERLAY_POPUP_MESSAGE_CLOSE_BUTTON
        ...
        pre_made = [
            ...
            STYLE_CLASS_BUTTON_FLAT
            STYLE_CLASS_BUTTON_RAISED
            STYLE_CLASS_BUTTON_CIRCULAR
            STYLE_CLASS_BUTTON_PILL
            STYLE_CLASS_BOX_LINKED
            STYLE_CLASS_TOOLBAR
            STYLE_CLASS_DIMMED
            STYLE_CLASS_FONT_HEADING_1
            STYLE_CLASS_FONT_HEADING_2
            STYLE_CLASS_FONT_HEADING_3
            STYLE_CLASS_FONT_HEADING_4
            ...
            STYLE_CLASS_CARD
            STYLE_CLASS_LIST_VIEW_SIDEBAR
            STYLE_CLASS_LIST_VIEW_RICH_LIST
            STYLE_CLASS_LIST_VIEW_DATA_TABLE
            STYLE_CLASS_LIST_VIEW_MENUBAR
            STYLE_CLASS_ICON_DROPSHADOW
            STYLE_CLASS_ICON_SMALL
            STYLE_CLASS_CHECK_BUTTON_ROUND
        ...
        for property in pre_made
            @test !isempty(get_name(x))
        end
            
        for x in properties
            set_property!(class, STYLE_TARGET_SELF, "inherit")
            @test get_property(class, STYLE_TARGET_SELF, "inherit")
        end
