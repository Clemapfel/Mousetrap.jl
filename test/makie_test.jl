...
# maps hash(GLMakieArea) too GLMakie.Screen
const screens = Dict{UInt64, GLMakie.Screen}()

"""
## GLMakieArea <: Widget
`GLArea` wrapper that automatically connects all necessary callbacks in order for it to be used the GLMakie render target 
