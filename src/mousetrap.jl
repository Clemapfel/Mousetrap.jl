...
###### style.jl
    ...
    @export_function StyleClass get_name String
    @export_function StyleClass serialize String
    ...
    const StyleClassTarget = String
    export StyleClassTarget

    const StyleClassProperty = String
    ...
    function remove_style_class!(widget::Widget, class::StyleClass)
        remove_css_class!(widget, get_name(class))
    end
    export remove_style_class!
    ...
    @define_style_property COLOR
    @define_style_property BACKGROUND_COLOR
    @define_style_property OPACITY
    ...
    @define_style_property FONT_TRANSFORM
    @define_style_property CARET_COLOR
    @define_style_property TEXT_DECORATION
    @define_style_property TEXT_DECORATION_COLOR
    @define_style_property TEXT_DECORATION_STYLE
    @define_style_property TEXT_SHADOW
    @define_style_property ICON_SIZE
    @define_style_property TRANSFORM
    @define_style_property TRANSFORM_ORIGIN
    @define_style_property BORDER
    @define_style_property BORDER_STYLE
    @define_style_property BORDER_COLOR
    @define_style_property BORDER_WIDTH
    @define_style_property BORDER_RADIUS
    @define_style_property BORDER_SPACING
    @define_style_property OUTLINE
    @define_style_property OUTLINE_STYLE
    @define_style_property OUTLINE_COLOR
    @define_style_property OUTLINE_WIDTH
    @define_style_property BOX_SHADOW
    @define_style_property BACKGROUND_CLIP
    @define_style_property BACKGROUND_ORIGIN
    @define_style_property BACKGROUND_SIZE
    @define_style_property BACKGROUND_POSITION
    @define_style_property BACKGROUND_REPEAT
    @define_style_property TRANSITION
    @define_style_property TRANSITION_PROPERTY
    @define_style_property TRANSITION_DURATION
    @define_style_property TRANSITION_TIMING_FUNCTION
    @define_style_property TRANSITION_DELAY
    @define_style_property ANIMATION
    @define_style_property ANIMATION_NAME
    @define_style_property ANIMATION_DURATION
    @define_style_property ANIMATION_TIMING_FUNCTION
    @define_style_property ANIMATION_ITERATION_COUNT
    @define_style_property ANIMATION_DIRECTION
    @define_style_property ANIMATION_PLAY_STATE
    @define_style_property ANIMATION_DELAY
    @define_style_property ANIMATION_FILL_MODE
    ...
    @define_style_target ACTION_BAR
    @define_style_target ACTION_BAR_BOX_START
    @define_style_target ACTION_BAR_BOX_END
    @define_style_target ASPECT_FRAME
    @define_style_target BOX
    @define_style_target BUTTON
    @define_style_target BUTTON_PRESSED
    @define_style_target CENTER_BOX
    @define_style_target CHECK_BUTTON
    @define_style_target CHECK_BUTTON_CHECK_MARK_ACTIVE
    @define_style_target CHECK_BUTTON_CHECK_MARK_INCONSISTENT
    @define_style_target CHECK_BUTTON_CHECK_MARK_INACTIVE
    @define_style_target CLAMP_FRAME
    @define_style_target COLUMN_VIEW
    @define_style_target DROP_DOWN
    @define_style_target ENTRY
    @define_style_target ENTRY_TEXT
    @define_style_target EXPANDER
    @define_style_target EXPANDER_TITLE
    @define_style_target EXPANDER_TITLE_ARROW
    @define_style_target FLOW_BOX
    @define_style_target FLOW_BOX_CHILD
    @define_style_target FRAME
    @define_style_target GRID
    @define_style_target GRID_VIEW
    @define_style_target GRID_VIEW_CHILDREN
    @define_style_target GRID_VIEW_SELECTED
    @define_style_target GRID_VIEW_NOT_SELECTED
    @define_style_target HEADER_BAR
    @define_style_target IMAGE_DISPLAY
    @define_style_target LABEL
    @define_style_target LEVEL_BAR
    @define_style_target LEVEL_BAR_TROUGH
    @define_style_target LEVEL_BAR_BLOCK_LOW
    @define_style_target LEVEL_BAR_BLOCK_HIGH
    @define_style_target LEVEL_BAR_BLOCK_FULL
    @define_style_target LIST_VIEW
    @define_style_target LIST_VIEW_CHILDREN
    @define_style_target LIST_VIEW_SELECTED
    @define_style_target LIST_VIEW_NOT_SELECTED
    @define_style_target MENU_BAR
    @define_style_target MENU_BAR_ITEM
    @define_style_target MENU_BAR_DISABLED_ITEM
    @define_style_target MENU_BAR_SELECTED_ITEM
    @define_style_target NOTEBOOK
    @define_style_target NOTEBOOK_TABS
    @define_style_target NOTEBOOK_SELECTED_TAB
    @define_style_target OVERLAY
    @define_style_target PANED
    @define_style_target PANED_HANDLE
    @define_style_target PANED_START_CHILD
    @define_style_target PANED_END_CHILD
    @define_style_target POPOVER
    @define_style_target POPOVER_ARROW
    @define_style_target POPOVER_BUTTON
    ...
    @define_style_target PROGRESS_BAR_TROUGH
    @define_style_target PROGRESS_BAR_TEXT
    @define_style_target PROGRESS_BAR_DURING_PULSE
    @define_style_target REVEALER
    @define_style_target SCALE
    @define_style_target SCALE_TROUGH
    @define_style_target SCALE_TROUGH_FILL
    @define_style_target SCALE_SLIDER
    @define_style_target SCALE_VALUE_TEXT
    @define_style_target SCROLLBAR
    ...
    @define_style_target STACK_SIDEBAR
    @define_style_target SWITCH
    ...
    @define_style_target TOGGLE_BUTTON_NOT_ACTIVE
    ...
    @define_pre_made_style_class DESTRUCTIVE_ACTION
    @define_pre_made_style_class BUTTON_FLAT
    @define_pre_made_style_class BUTTON_RAISED
    @define_pre_made_style_class BUTTON_CIRCULAR
    @define_pre_made_style_class BUTTON_PILL
    @define_pre_made_style_class BOX_LINKED
    @define_pre_made_style_class TOOLBAR
    @define_pre_made_style_class DIMMED
    @define_pre_made_style_class FONT_HEADING_1
    @define_pre_made_style_class FONT_HEADING_2
    @define_pre_made_style_class FONT_HEADING_3
    @define_pre_made_style_class FONT_HEADING_4
    @define_pre_made_style_class FONT_LARGER
    @define_pre_made_style_class FONT_REGULAR
    @define_pre_made_style_class FONT_CAPTION_HEADING
    @define_pre_made_style_class FONT_CAPTION
    @define_pre_made_style_class FONT_MONOSPACE
    @define_pre_made_style_class FONT_NUMERIC
    @define_pre_made_style_class COLOR_ACCENT
    @define_pre_made_style_class COLOR_SUCCESS
    @define_pre_made_style_class COLOR_WARNING
    @define_pre_made_style_class COLOR_ERROR
    @define_pre_made_style_class ACTIVATABLE
    @define_pre_made_style_class CARD
    @define_pre_made_style_class LIST_VIEW_SIDEBAR
    @define_pre_made_style_class LIST_VIEW_RICH_LIST
    @define_pre_made_style_class LIST_VIEW_DATA_TABLE
    @define_pre_made_style_class LIST_VIEW_MENUBAR
    @define_pre_made_style_class ICON_DROPSHADOW
    @define_pre_made_style_class ICON_SMALL
    @define_pre_made_style_class CHECK_BUTTON_ROUND
    @define_pre_made_style_class ON_SCREEN_DISPLAY
    @define_pre_made_style_class BACKGROUND
    @define_pre_made_style_class VIEW
